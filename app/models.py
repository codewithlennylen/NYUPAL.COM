...
class Subscription(db.Model):
    ...
    start_date = db.Column(db.String(50), default=str(datetime.date.today()), nullable=False)  # Auto-Generated During Input
...
#* Not manually added, done via the Payment Preprocessor's CallbackURL
# other routes simply cross-reference details from this table.
